...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" Runat="Server">
    <section class="mx-3 rounded p-2 card shadowCard" style="background-color:rgba(0, 0, 254, 0.30)">
        ...
        <div class="d-flex justify-content-between mb-3">
            ...
            <asp:HyperLink runat="server" ID="add" NavigateUrl="~/AdminPanel/Country/Add"><span class="btn btn-success shadowCard">Add New</span></asp:HyperLink>
        </div>
                    ...
                    <asp:TemplateField HeaderText="Delete">
                        <ItemTemplate>
                            <asp:Button runat="server" ID="btnDelete" Text="Delete" CssClass="btn btn-danger btn-sm shadowCard"
                                CommandName="deleteRecord" OnClientClick="javascript : return confirm('Are you sure you want to delete?')" CommandArgument='<%# Eval("CountryID").ToString() %>' />
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Edit">
                        <ItemTemplate>
                            <asp:HyperLink runat="server" ID="btnEdit" NavigateUrl='<%# "~/AdminPanel/Country/Edit/"+ MultiUserAddressBook.EncryptionDecryption.Base64Encode( Eval("CountryID").ToString().Trim()) %>'
